                   ...
                   <section class="login_content" style="padding:5px;">
                       ...
                       <table class="span6">
                        ...
                        <tr>
                           ...
                           <td><?php $customer_invoices = $this->invoices_database->fetch_from_service_id($service_data[0]['id']);
                                 if(is_array($customer_invoices)){
                                    foreach($customer_invoices as $invoice){
                                    echo $invoice['invoice_date']." ";?>
                                    <a href="<?php echo base_url().'invoices/'.$invoice['invoice_link'];?>" title="view"><?php echo $invoice['invoice_link'];?></a><br />
                                 <?php } } else{
                                    echo "You do not have any invoices<br/>on this service";
                                 } ?>
                          </td>
                        </tr>
